...
<template>
  <div class="flex h-full flex-col items-center justify-center gap-6 px-6">
    <div class="text-center">
      ...
      <h1 class="mt-2 text-2xl font-semibold">Join biert</h1>
      <p class="text-sm text-neutral-400">Friends-only. No feeds, no noise — just cheers.</p>
    </div>
    ...
    <NuxtLink :to="{ path: '/login', query: route.query }" class="text-sm text-neutral-400">
      Already have an account? <span class="text-amber-400">Log in</span>
    </NuxtLink>
  </div>
</template>
